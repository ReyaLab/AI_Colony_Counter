...
This is the code to originally create/finetune the model

Took Segformer B3, changed it to a 3-classification model, had to edit top layer
"""
...
mask_paths = '/home/mattc/Documents/ColonyAssaySegformer/All_MN_images/labels_tern_cropped/' 
...
model = SegformerForSemanticSegmentation.from_pretrained(
    ...
    num_labels=3,  # Since you have 2 classes: background and colonies
    ignore_mismatched_sizes=True
)
model.decode_head.classifier = torch.nn.Conv2d(768, 3, kernel_size=(1, 1))  # Reinitialize with 3 classes (768 is the feature size)
model.decode_head.classifier.bias = torch.nn.Parameter(torch.zeros(3))  # Reinitialize bias
...
trainer.save_model("/home/mattc/Documents/ColonyAssaySegformer/segformer_colony_model_ternary")
