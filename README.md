...
Currently only works for 1536x2048 images but check for updates to fix this. The images are cut into 12 sections and fed into the segmentation model as tiles.
